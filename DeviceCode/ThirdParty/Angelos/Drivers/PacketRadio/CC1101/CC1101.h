...
#ifndef _DRIVERS_CC1101_H_
#define _DRIVERS_CC1101_H_ 1

#define PACKETRADIO_MAXPACKETSIZE 63
...
struct CC1101_CONFIG
{
    ...
    static LPCSTR GetDriverName() { return "CC1101"; }
};

extern void CC1101_Config_Initialize();
extern void CC1101_Config_ConfigureDevice();
extern CC1101_CONFIG g_CC1101_Config;
//--//
namespace CC1101_Driver
{
	void Initialize();
	void RegisterRXCallback(PACKETRADIO_RECEIVED_DATA cb);
	...
	inline void HandleOverflow(void);
	UINT32 GetMaxPacketSize();
	UINT8 GetRxStatus(void);
	UINT8 TransmitData(UINT8* Data, size_t size);
	void SetAddress(UINT32 address);
	extern UINT32 Address;
	extern UINT8 TXBuffer[67];
	extern UINT8 RXBuffer[67];
	volatile extern BOOL IsTransmitting;
};

#endif  // _DRIVERS_CC1101_H_
