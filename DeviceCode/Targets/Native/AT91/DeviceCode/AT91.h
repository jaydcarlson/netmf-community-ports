...
// AT91_Analog_DRIVER
//
struct AT91_Analog_Driver
{
	static BOOL Initialize( ANALOG_CHANNEL channel, INT32 precisionInBits );
	static INT32 Read( ANALOG_CHANNEL channel );
	static UINT32 ADChannels();
	static GPIO_PIN GetPinForChannel( ANALOG_CHANNEL channel );
	static BOOL GetAvailablePrecisionsForChannel( ANALOG_CHANNEL channel, INT32* precisions, UINT32& size );
